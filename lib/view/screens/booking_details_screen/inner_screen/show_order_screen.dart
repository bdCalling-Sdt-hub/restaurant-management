...
class _BookNowState extends State<ShowOrderScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: GetBuilder<ShowOrderController>(builder: (controller) {
        return Padding(
                        ...
                        itemBuilder: (context, index) {
                          return Stack(
                            children: [
                              ...
                              ///====================Closed button  =================  ///
                              controller.model.data?.items?[index].isPaid ==
                                      false
                                  ? Positioned(
                                      top: 10,
                                      right: 0,
                                          ...
                                          setState(() {
                                            controller.removeFromCart(
                                                bookingId: controller
                                                        ...
                                                        .toString() ??
                                                    "",
                                                itemId: controller.model.data
                                                        ?.items?[index].sId ??
                                                    "",
                                                amount: controller.model.data
                                                        ?.items?[index].amount
                                                        .toString() ??
                                                    "");
                                            print("=====ID ${id}");
