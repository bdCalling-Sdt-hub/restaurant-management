...
import 'package:restaurant_management/view/screens/review_screen/review_screen.dart';
...
class _BookNowState extends State<BookingDetailsScreen> {
  ...
  @override
  void initState() {
    GetSingleBookingController controller =
        Get.put(GetSingleBookingController());
  ...
  Widget build(BuildContext context) {
    return GetBuilder<GetSingleBookingController>(builder: (controller) {
      return Scaffold(
          appBar: AppBar(
            toolbarHeight: 80,
            leading: Row(
            ...
            actions: [
              controller.model.data?[0].status == "active"
                  ? Container(
                      ...
                      child: GestureDetector(
                          onTap: () {
                            Get.toNamed(AppRoute.reviewScreen,
                                arguments:
                                    controller.model.data?[0].restaurant);
                            print(
                                "========================ID${controller.model.data?[0].restaurant}");
                          },
                          child: Container(
                            child: const Row(
                              children: [
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          ...
                          CustomText(
                            text:
                                controller.model.data?[0].time.toString() ?? "",
                            fontSize: 16,
                            fontWeight: FontWeight.w300,
                            left: 12,
                          )
                      ...
                      Row(
                        children: [
                          ...
                          CustomText(
                            text: controller.model.data?[0].table?.seats
                                    .toString() ??
                                "",
                            fontSize: 16,
                            fontWeight: FontWeight.w300,
                      ...
                      Row(
                        children: [
                          ...
                          CustomText(
                            text: controller.model.data?[0].table?.tableName
                                    .toString() ??
                                "",
                            fontSize: 16,
                            fontWeight: FontWeight.w300,
                      ...
                      controller.model.data?[0].status == "active"
                          ? CustomElevatedButton(
                              onPressed: () {
                                Get.toNamed(AppRoute.showOrderScreen,
                                    arguments: id);

                                print("==================+ID ${id}");
                              },
                              titleText: "Show Order",
                              buttonHeight: 40,
