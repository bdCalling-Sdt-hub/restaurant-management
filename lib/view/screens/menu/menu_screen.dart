...
class _MenuScreenState extends State<MenuScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: GetBuilder<MenuControllerGet>(builder: (controller) {
                              ...
                              child: Container(
                                ...
                                decoration: BoxDecoration(
                                    color: controller.selectedCategory == index
                                        ...
                                        : const Color(0xffC8E0BD),
                                    borderRadius: BorderRadius.circular(8)),
                                child: Column(
                                  children: [
                                    Image.network(
                                      "${ApiUrl.imageUrl}${controller.menuCategoryList[index].image}",
                                      height: 60,
                                      width: 60,
                                    ),
                                    CustomText(
                                      text: controller
                                              .menuCategoryList[index].title
                                              .toString() ??
                                          "",
                                      color:
