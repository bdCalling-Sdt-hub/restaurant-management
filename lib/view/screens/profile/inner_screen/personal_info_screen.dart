...
class _PersonalInfoScreenState extends State<PersonalInfoScreen> {
  List<Map<String, dynamic>> data = [
    {"routeName": "Personal Information", "icon": const Icon(Icons.person_outline_rounded, color: Colors.black,)},
    ...
    {"routeName": "Logout", "icon": const Icon(Icons.logout, color: Colors.red,)},
    {"routeName": "Logout", "icon": const Icon(Icons.logout, color: Colors.red,)},
  ];
              ...
              child: Container(
                ...
                child: Column(
                  children: [
                    ...
                    GestureDetector(
                      onTap: () {
                        EditPersonalInfoController editPersonalInfoController =
                            Get.put(EditPersonalInfoController());
                        editPersonalInfoController.nameController.text =
                            controller.model.data?.fullName.toString() ?? "";
                        editPersonalInfoController.numberController.text =
                            controller.model.data?.phoneNumber.toString() ?? "";
                        editPersonalInfoController.profileImage =
                            controller.image;
